...
- [X] option to replace dark mode pages with light (example: https://tldr.tech/ai/2026-07-17)
- [X] show full timestamp if the article date is less than 24 hours old
